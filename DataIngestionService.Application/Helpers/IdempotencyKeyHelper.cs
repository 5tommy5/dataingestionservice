...
public static class IdempotencyKeyHelper
{
    ...
    {
        var raw = $"{request.CustomerId}|{request.TransactionDate:yyyy-MM-ddTHH:mm:ss}|{request.Amount.ToString(CultureInfo.InvariantCulture)}|{request.Currency}|{request.SourceChannel}";
